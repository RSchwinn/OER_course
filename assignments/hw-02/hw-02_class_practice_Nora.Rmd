...
# df_temp$species = factor(df_temp$species, levels = c("Eevee", "Caterpie", "Pidgey", "Weedle") )
 ggplot(data = df_temp,
    ...
    labs(y = "Frequency",
         x = "Species",
         title = "Post-evolution stronger attack of the Pokémon",
         subtitle = "by species")+
     guides(fill=guide_legend(title="Stronger Attack Type")) +
     theme_minimal()
```
